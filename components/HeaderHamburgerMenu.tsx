...
const HeaderHamburgerMenu = ({ navigation }: HeaderHamburgerMenuProps) => {
  ...
  return (
    <details ref={detailsRef} className="sm:hidden">
      <summary className="inline-flex h-10 w-10 cursor-pointer list-none items-center justify-center rounded-full border border-border">
      ...
      <nav className={HAMBURGER_MENU_PANEL_CLASS}>
        <HeaderMenuLinks
          ...
          itemClassName="text-sm uppercase tracking-[0.1em]"
          keyPrefix="mobile-"
