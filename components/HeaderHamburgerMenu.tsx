...
const HeaderHamburgerMenu = ({ navigation }: HeaderHamburgerMenuProps) => {
  ...
  return (
    <details ref={detailsRef} className="sm:hidden">
      <summary className="inline-flex h-10 w-10 cursor-pointer list-none items-center justify-center rounded-full border border-border bg-surface-strong text-[var(--theme-text)] shadow-[0_8px_18px_rgba(18,18,18,0.06)] transition hover:bg-[color-mix(in_srgb,var(--theme-bg)_88%,var(--theme-surface)_12%)]">
